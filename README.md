...
4. <b>The provider can view associated drug information (e.g., adverse reactions, black box warnings, and dosage and administration) pulled from the [OpenFDA Drug API](https://open.fda.gov/apis/drug/ "OpenFDA Drug API")</b>
